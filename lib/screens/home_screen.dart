...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _fetchMedia() async {
    try {
      final querySnapshot =
          await FirebaseFirestore.instance.collection('marketing_images').get();
        ...
        for (var doc in querySnapshot.docs) {
          ...
          if (data['files'] != null) {
            ...
            final processedFiles =
                files.map((file) {
                  if (file['url'] != null &&
                      file['url'].toString().contains('drive.google.com')) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          SizedBox(height: 240, child: _buildSlider()),
          Expanded(
  ...
  Widget _buildDocumentsGrid(List documents) {
    ...
    return GridView.builder(
      ...
      itemBuilder:
          (context, index) => _buildDocumentCard(typedDocs[index], typedDocs),
    );
  }
      ...
      child: Container(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: () {
              final currentIndex = allDocs.indexWhere(
                (d) => d['url'] == doc['url'],
              );
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder:
                      (context) => DocumentSliderScreen(
                        documents: allDocs,
